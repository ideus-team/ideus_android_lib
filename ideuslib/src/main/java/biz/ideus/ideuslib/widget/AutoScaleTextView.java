...
public class AutoScaleTextView extends TextView{
    ...
    public void resizeText(int width, int height) {
        ...
        // Until we either fit within our text view or we had reached our min text size,
        // incrementally try smaller sizes
        while (textHeight > height && targetTextSize > mMinTextSize) {
            targetTextSize = changeTextSize(2, targetTextSize);
        ...
        if (mAddEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
            ...
            if (layout.getLineCount() > 0) {
                ...
                if (lastLine < 0) {
                    ...
                    try {
                        setText(String.valueOf(text.subSequence(0, end) + mEllipsis));
    ...
    private float changeTextSize(int lower, float targetTextSize) {
        targetTextSize = Math.max(targetTextSize - lower, mMinTextSize);
