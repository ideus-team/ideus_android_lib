...
public class CircleImageView extends ImageLoaderView {
    ...
    public void setLoadImage(String imageUrl) {
        loadImage(imageUrl);
    }
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs
                , R.styleable.ImageLoaderCircleView
                , defStyle
                , 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.ImageLoaderCircleView_civ_border_width
                , DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.ImageLoaderCircleView_civ_border_color
                , DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.ImageLoaderCircleView_civ_border_overlay
                , DEFAULT_BORDER_OVERLAY);
        mFillColor = a.getColor(R.styleable.ImageLoaderCircleView_civ_fill_color,
                DEFAULT_FILL_COLOR);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mFillColor != Color.TRANSPARENT) {
            canvas.drawCircle(mDrawableRect.centerX()
                    , mDrawableRect.centerY(), mDrawableRadius, mFillPaint);
        }
        canvas.drawCircle(mDrawableRect.centerX()
                , mDrawableRect.centerY(), mDrawableRadius, mBitmapPaint);
        if (mBorderWidth > 0) {
            canvas.drawCircle(mBorderRect.centerX()
                    , mBorderRect.centerY(), mBorderRadius, mBorderPaint);
        }
    }
