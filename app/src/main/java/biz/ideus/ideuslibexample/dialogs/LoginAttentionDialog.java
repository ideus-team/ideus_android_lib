...
public class LoginAttentionDialog extends CustomAttentionDialog {

    public LoginAttentionDialog(BaseActivity activity) {
        super(activity);
    }
    ...
    public String getAboutActionText() {
        return activity.getString(DialogModel.LOGIN_ATTENTION.resDialogName);
    }
